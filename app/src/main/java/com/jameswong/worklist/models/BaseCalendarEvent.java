package com.jameswong.worklist.models;
...
public class BaseCalendarEvent implements CalendarEvent {
     ...
     * @param endTimeMillis
     */
    public BaseCalendarEvent(int id, String title, String description, String location, int color, Calendar startTime, Calendar endTime, boolean allDay, String startAndEndTime, int agendaStatus, long startTimeMillis, long endTimeMillis) {
        this.mId = id;
        this.mTitle = title;
        this.mDescription = description;
        this.mLocation = location;
        ...
        this.mAllDay = allDay;
        this.mStartAndEndTime = startAndEndTime;
        this.mAgendaStatus = agendaStatus;
    ...
    public BaseCalendarEvent(BaseCalendarEvent calendarEvent) {
        ...
        this.mAgendaStatus = calendarEvent.getAgendaStatus();
    }
